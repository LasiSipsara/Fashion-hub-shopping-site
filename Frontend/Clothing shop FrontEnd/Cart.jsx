...
import {cartEmptyLogo} from '../images/cartempty.png'
...
const Cart = (customerId) => {
  ...
  if (!id) {
    const newLocal = <img src={cartEmptyLogo} alt="cart is empty" style={{ height: '25rem' }} />
    return (
      <Container>
      <Navbar />
      <Announcement />
    ...
    return (
      ...
      <Wrapper>
        ...
        <Bottom>
          <Info>
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
        <img src={cartEmptyLogo} alt="cart is empty" style={{height: '25rem'}}/>
