    ...
    <Container>
        <Wrapper>
            ...
            <Right>
              ...
              <>
                  <Menu><NavLink to="../pages/RegsitrationForm" >REGISTER</NavLink></Menu>
                  <Menu><NavLink to="../pages/LoginForm">SIGN IN</NavLink></Menu>
              </>
                )}
              ...
              <NavLink to="" ><ShoppingCartOutlined /></NavLink>
              </Badge>
              </Menu>
            </Right>
        </Wrapper>
